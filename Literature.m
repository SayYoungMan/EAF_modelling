...
% --------- First Addition ---------
total = 900;
gas_temp = zeros(1, total);
sSc_temp = zeros(1, total);
sSl_temp = zeros(1, total);
lSc_temp = zeros(1, total);
lSl_temp = zeros(1, total);
m_solid = zeros(1, total);
m_liquid = zeros(1, total);
m_solid_slag = zeros(1, total);
m_liquid_slag = zeros(1, total);

% --------- Second Addition ---------
total2 = 600;
gas_temp2 = zeros(1, total2);
sSc_temp2 = zeros(1, total2);
sSl_temp2 = zeros(1, total2);
lSc_temp2 = zeros(1, total2);
lSl_temp2 = zeros(1, total2);
m_solid2 = zeros(1, total2);
m_liquid2 = zeros(1, total2);
m_solid_slag2 = zeros(1, total2);
m_liquid_slag2 = zeros(1, total2);

% --------- Third Addition ---------
total3 = 900;
gas_temp3 = zeros(1, total3);
sSc_temp3 = zeros(1, total3);
sSl_temp3 = zeros(1, total3);
lSc_temp3 = zeros(1, total3);
lSl_temp3 = zeros(1, total3);
m_solid3 = zeros(1, total3);
m_liquid3 = zeros(1, total3);
m_solid_slag3 = zeros(1, total3);
m_liquid_slag3 = zeros(1, total3);
...
%     Q_gas = Q_arcgas + Q_sScgas + Q_lScgas + Q_lSlgas - Q_gaswater;
    ...
    dT_sSc = (Q_sSc*(1-(T_sSc/T_melt))) / (m_sSc*cp_sSc);
...
%     Q_lSl = Q_lSclSl + Q_sSclSl - Q_lSlgas - Q_lSlwater;
    ...
    rp = (R*T_gas/V_gas)*(dm_CO/M_CO + dm_CO2/M_CO2 + dm_O2/M_O2 + dm_H2O/M_H2O) ...
        + (R*dT_gas/V_gas)*(m_CO/M_CO + m_CO2/M_CO2 + m_O2/M_O2 + m_H2O/M_H2O);
%     if step == 159999
%         m_sSc_Fe = m_sSc_Fe + 24262.5;
%         m_sSc_C = m_sSc_C + 100;
%         m_sSc_Si = m_sSc_Si + 150;
%         m_sSc_Cr = m_sSc_Cr + 50;
%         m_sSc_P = m_sSc_P + 12.5;
%         m_sSc_Mn = m_sSc_Mn + 150;
%         m_sSc_comb = m_sSc_comb + 275;
%     end
...
m_Fe_sSc = m_Fe_sSc + 24262.5;
m_C_sSc = m_C_sSc + 100;
m_Si_sSc = m_Si_sSc + 150;
m_Cr_sSc = m_Cr_sSc + 50;
m_P_sSc = m_P_sSc + 12.5;
m_Mn_sSc = m_Mn_sSc + 150;
m_comb_sSc = m_comb_sSc + 275;
...
%         sqrt((1+R^2+H^2)^2 - 4*R^2)));
    ...
    % Net heat flow in liquid metal zone (lSc)
    % CO post combustion and Oxygen burner neglected
    Q_lSc = (Q_arc - dH_Th - 25000)*K_sSclSc - Q_lScchem ...
    - Q_lScsSc - Q_lScsSl - Q_lSclSl - Q_lScgas - Q_lScwater - Q_lScRAD;
    
    
    % Net heat flow in solid slag zone
    Q_sSl = Q_sScsSl*5 + Q_lScsSl - Q_sSlwater;
...
%     Q_gas = Q_arcgas + Q_sScgas + Q_lScgas + Q_lSlgas - Q_gaswater;
    ...
    % Temperature change of sSc
    dT_sSc = (Q_sSc*(1-(T_sSc/T_melt))) / ((m_sSc/M_sSc)*Cp_sSc);
    ...
    % ===================== For Graph =======================
    if mod(step, 1/(ts*5)) == 0
        gas_temp2(floor(step*ts*5)) = T_gas;
        sSc_temp2(floor(step*ts*5)) = T_sSc;
        sSl_temp2(floor(step*ts*5)) = T_sSl;
        lSc_temp2(floor(step*ts*5)) = T_lSc;
        lSl_temp2(floor(step*ts*5)) = T_lSl;
        m_solid2(floor(step*ts*5)) = m_sSc;
        m_liquid2(floor(step*ts*5)) = m_lSc;
        m_solid_slag2(floor(step*ts*5)) = m_sSl;
        m_liquid_slag2(floor(step*ts*5)) = m_lSl;
    end
...
for step = 20001:20000+(secs/5)/ts
...
%         sqrt((1+R^2+H^2)^2 - 4*R^2)));
    ...
    % Net heat flow in solid steel zone (sSc)
    % CO post combustion and Oxygen burner neglected
    Q_sSc = (Q_arc - dH_Th + 60000)*(1-K_sSclSc) + Q_lScsSc ...
    - Q_sScsSl - Q_sSclSl - Q_sScgas - Q_sScwater - Q_sScRAD;
    
    % Net heat flow in liquid metal zone (lSc)
    % CO post combustion and Oxygen burner neglected
    Q_lSc = (Q_arc - dH_Th + 60000)*K_sSclSc - Q_lScchem ...
    - Q_lScsSc - Q_lScsSl - Q_lSclSl - Q_lScgas - Q_lScwater - Q_lScRAD;
...
%     Q_gas = Q_arcgas + Q_sScgas + Q_lScgas + Q_lSlgas - Q_gaswater;
    ...
    % Temperature change of sSc
    dT_sSc = (Q_sSc*(1-(T_sSc/T_melt))) / (m_sSc*cp_sSc*2);
...
%         sqrt((1+R^2+H^2)^2 - 4*R^2)));
    ...
    % Net heat flow in solid steel zone (sSc)
    % CO post combustion and Oxygen burner neglected
    Q_sSc = (Q_arc - dH_Th + 120000)*(1-K_sSclSc) + Q_lScsSc ...
    - Q_sScsSl - Q_sSclSl - Q_sScgas - Q_sScwater - Q_sScRAD;
    
    % Net heat flow in liquid metal zone (lSc)
    % CO post combustion and Oxygen burner neglected
    Q_lSc = (Q_arc + dH_Th + 120000)*K_sSclSc - Q_lScchem ...
    - Q_lScsSc - Q_lScsSl - Q_lSclSl - Q_lScgas - Q_lScwater - Q_lScRAD;
...
%     Q_gas = Q_arcgas + Q_sScgas + Q_lScgas + Q_lSlgas - Q_gaswater;
    ...
    % ===================== For Graph =======================
    if mod(step, 1/(ts*5)) == 0
        gas_temp3(floor(step*ts*5)) = T_gas;
        sSc_temp3(floor(step*ts*5)) = T_sSc;
        sSl_temp3(floor(step*ts*5)) = T_sSl;
        lSc_temp3(floor(step*ts*5)) = T_lSc;
        lSl_temp3(floor(step*ts*5)) = T_lSl;
        m_solid3(floor(step*ts*5)) = m_sSc;
        m_liquid3(floor(step*ts*5)) = m_lSc;
        m_solid_slag3(floor(step*ts*5)) = m_sSl;
        m_liquid_slag3(floor(step*ts*5)) = m_lSl;
    end
...
lSl_temp = cat(2,lSl_temp,lSl_temp2);
sSc_temp = cat(2,sSc_temp,sSc_temp2);
sSl_temp = cat(2,sSl_temp,sSl_temp2);

m_solid = cat(2,m_solid, m_solid2);
m_liquid = cat(2,m_liquid, m_liquid2);
m_solid_slag = cat(2,m_solid_slag, m_solid_slag2);
m_liquid_slag = cat(2,m_liquid_slag, m_liquid_slag2);

gas_temp = cat(2,gas_temp,gas_temp3);
lSc_temp = cat(2,lSc_temp,lSc_temp3);
